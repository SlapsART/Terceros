...
export const cosmosTheme = createTheme({
  ...
  palette: {
    ...
    // COLORES PRIMARIOS - Violeta/Morado Cosmos - actualizado desde Figma Handoff
    primary: {
      50: '#e1e6ff',        // actualizado desde Figma Handoff (antes: #f3f3ff)
      100: '#b6c0ff',       // actualizado desde Figma Handoff (antes: #f3f3ff)
      200: '#d6d5ff',       // Tono claro
      300: '#b9b3ff',       // Tono medio-claro
      400: '#495bdc',       // actualizado desde Figma Handoff (antes: #9588fd)
      500: '#2f43d0',       // actualizado desde Figma Handoff - Color principal COSMOS (antes: #5323de)
      600: '#7358fa',       // Tono medio-oscuro (hover)
      700: '#6135f2',       // Tono oscuro
      800: '#451dba',       // Tono muy oscuro
      900: '#3a1a98',       // Tono más oscuro (dark)
      main: '#2f43d0',      // actualizado desde Figma Handoff - Color principal de Cosmos (antes: #5323de)
      light: '#495bdc',     // actualizado desde Figma Handoff - Variante clara (antes: #9588fd)
  ...
  // ============================================================================
  // TIPOGRAFÍA COSMOS - INTER & SCHIBSTED GROTESK (especificaciones exactas del Figma)
  // ============================================================================
  typography: {
    fontFamily: '"Inter", sans-serif', // Exacto del Figma - solo Inter

    // JERARQUÍA DE TÍTULOS - Basada en tokens Cosmos - actualizado desde Figma Handoff
    h1: {
      fontFamily: '"Schibsted Grotesk", "Inter", "Roboto", sans-serif', // actualizado desde Figma Handoff
      fontSize: '2.5rem',      // 40px según Size.H1
      fontWeight: 600,         // actualizado desde Figma Handoff - Semibold (antes: 400)
    ...
    h5: {
      ...
      fontWeight: 600,         // actualizado desde Figma Handoff - Semibold (antes: 400)
      lineHeight: '1.125rem',  // actualizado desde Figma Handoff - 18px (antes: 24px)
      letterSpacing: '0px',    // Según LetterSpacing.H5
    },
    h6: {
      fontFamily: '"Schibsted Grotesk", "Inter", "Roboto", sans-serif', // actualizado desde Figma Handoff
      fontSize: '1rem',        // 16px según Size.H6
      fontWeight: 600,         // actualizado desde Figma Handoff - Semibold (antes: 500)
    ...
    subtitle1: {
      ...
      fontWeight: 500,         // actualizado desde Figma Handoff — Inter Medium (antes: 400)
  ...
  components: {
    ...
    MuiChip: {
      styleOverrides: {
        ...
        sizeSmall: {
          height: 16, // actualizado desde Figma Handoff — Cosmos usa 16px (antes: 24px MUI default)
        },
        sizeMedium: {
          height: 20, // actualizado desde Figma Handoff — Cosmos usa 20px (antes: 32px MUI default)
        },
        filled: {
          '&.MuiChip-colorDefault': {
            backgroundColor: '#eaebec', // grey.200 — actualizado desde Figma Handoff (antes: #e4e5e7)
            color: '#101840', // text.primary — actualizado desde Figma Handoff (antes: #5a5e73)
            '& .MuiChip-deleteIcon': {
          ...
          '&.MuiChip-colorPrimary': {
            backgroundColor: '#e1e6ff', // actualizado desde Figma Handoff (antes: #c4e1f5)
            color: '#2f43d0', // actualizado desde Figma Handoff (antes: #5a5e73)
            '&:hover': {
              backgroundColor: '#c8cfff', // actualizado desde Figma Handoff (antes: #a2cdee)
            },
          },
        ...
        outlined: {
          ...
          '&.MuiChip-outlinedPrimary': {
            border: '1px solid #2f43d0', // actualizado desde Figma Handoff (antes: #5323de)
            backgroundColor: 'transparent',
            color: '#2f43d0', // actualizado desde Figma Handoff (antes: #5323de)
          },
          ...
          '&.MuiChip-outlinedSuccess': {
            ...
            backgroundColor: 'transparent',
            color: '#72b525', // actualizado desde Figma Handoff (antes: #8fc93a)
          },
          '&.MuiChip-outlinedError': {
            border: '1px solid #c63434', // actualizado desde Figma Handoff (antes: #d14343)
            backgroundColor: 'transparent',
            color: '#c63434', // actualizado desde Figma Handoff (antes: #d14343)
          },
          ...
          '&.MuiChip-outlinedInfo': {
            ...
            backgroundColor: 'transparent',
            color: '#228db8', // actualizado desde Figma Handoff (antes: #2d9fc5)
          },
        },
      },
    },
    ...
    // @ts-ignore - MuiDataGrid is from @mui/x-data-grid package
    MuiDataGrid: {
      styleOverrides: {
        root: ({ theme }: any) => ({
          '&.MuiDataGrid-root--densityCompact': {
            ...
            '& .MuiCircularProgress-root ~ .MuiBox-root .MuiTypography-caption': {
              fontSize: `${parseFloat(theme.typography.caption.fontSize) * 0.67}rem !important`, // Smaller text for percentage (67% of caption)
            },
