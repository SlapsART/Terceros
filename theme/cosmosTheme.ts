...
export const cosmosTheme = createTheme({
  ...
  palette: {
    ...
    primary: {
      ...
      main: '#5323de',      // Color principal de Cosmos
  ...
  components: {
    ...
    MuiChip: {
      styleOverrides: {
        ...
        sizeSmall: {
          height: 16, // actualizado desde Figma Handoff — cosmos usa 16px, no 24px (MUI default)
        },
        sizeMedium: {
          height: 20, // actualizado desde Figma Handoff — cosmos usa 20px, no 32px (MUI default)
        },
        filled: {
          '&.MuiChip-colorDefault': {
            backgroundColor: '#eaebec', // actualizado desde Figma Handoff — grey.200
            color: '#101840', // actualizado desde Figma Handoff — text.primary (antes: #5a5e73)
            '& .MuiChip-deleteIcon': {
          ...
          '&.MuiChip-colorPrimary': {
            backgroundColor: '#f3f3ff', // primary.50 — Figma usa var(--primary/50)
            color: '#5323de', // primary.main — Figma usa var(--primary/main)
            '&:hover': {
              backgroundColor: '#d6d5ff', // primary.200
            },
          },
          ...
          '&.MuiChip-colorError': {
            ...
            color: '#c63434', // actualizado desde Figma Handoff — tono 700 (antes: #5a5e73)
            '&:hover': {
          ...
          '&.MuiChip-colorWarning': {
            ...
            color: '#bf360c', // actualizado desde Figma Handoff — deepOrange/900 (antes: #5a5e73)
            '&:hover': {
          ...
          '&.MuiChip-colorInfo': {
            ...
            color: '#228db8', // actualizado desde Figma Handoff — tono 700 (antes: #5a5e73)
            '&:hover': {
              backgroundColor: '#9cd8fa',
            },
          },
          '&.MuiChip-colorSuccess': {
            backgroundColor: '#e8f5d0', // actualizado desde Figma Handoff (antes: #ddf8c3)
            color: '#3f6212', // actualizado desde Figma Handoff — tono oscuro (antes: #5a5e73)
            '&:hover': {
              backgroundColor: '#c8f3a2',
            },
          },
        },
        outlined: {
          ...
          '&.MuiChip-outlinedSuccess': {
            border: '1px solid #72b525', // actualizado desde Figma Handoff — tono 700 (antes: #8fc93a)
            backgroundColor: 'transparent',
            color: '#72b525',
          },
          '&.MuiChip-outlinedError': {
            border: '1px solid #c63434', // actualizado desde Figma Handoff — tono 700 (antes: #d14343)
            backgroundColor: 'transparent',
            color: '#c63434',
          },
          ...
          '&.MuiChip-outlinedInfo': {
            border: '1px solid #228db8', // actualizado desde Figma Handoff — tono 700 (antes: #2d9fc5)
            backgroundColor: 'transparent',
            color: '#228db8',
          },
        },
    ...
    MuiAlert: {
      styleOverrides: {
        standardError: {
          color: '#5f2120', // components.alert.error.color — actualizado desde Figma Handoff (antes: #101840)
